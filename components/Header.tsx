      ...
      <section className="hidden border-b border-slate-200 bg-white md:block">
        <div className=" flex w-full max-w-[1360px] flex-col gap-2 px-4 py-2 text-[11px] text-slate-600 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <div className="flex w-full items-center justify-center gap-2 sm:w-auto sm:justify-end sm:gap-3">
            ...
            <a className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 text-slate-700 transition-colors hover:border-[#2f86ff] hover:text-[#2f86ff] sm:h-7 sm:w-7" href="#" aria-label="Facebook">
              <SocialIcon Icon={FaFacebookF} />
            </a>
            <a className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 text-slate-700 transition-colors hover:border-[#2f86ff] hover:text-[#2f86ff] sm:h-7 sm:w-7" href="#" aria-label="X">
              <SocialIcon Icon={FaXTwitter} />
            </a>
            <a className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 text-slate-700 transition-colors hover:border-[#2f86ff] hover:text-[#2f86ff] sm:h-7 sm:w-7" href="#" aria-label="Instagram">
              <SocialIcon Icon={FaInstagram} />
            </a>
            <a className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 text-slate-700 transition-colors hover:border-[#2f86ff] hover:text-[#2f86ff] sm:h-7 sm:w-7" href="#" aria-label="LinkedIn">
